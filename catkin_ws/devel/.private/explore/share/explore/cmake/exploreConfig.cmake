...
if("TRUE" STREQUAL "TRUE")
  set(explore_SOURCE_PREFIX /home/ams-notebook/ams-bw-ws2425/catkin_ws/src/explore)
  set(explore_DEVEL_PREFIX /home/ams-notebook/ams-bw-ws2425/catkin_ws/devel/.private/explore)
  set(explore_INSTALL_PREFIX "")
  set(explore_PREFIX ${explore_DEVEL_PREFIX})
else()
  set(explore_SOURCE_PREFIX "")
  set(explore_DEVEL_PREFIX "")
  set(explore_INSTALL_PREFIX /home/ams-notebook/ams-bw-ws2425/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'explore' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ams-notebook/ams-bw-ws2425/catkin_ws/src/explore/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT explore_NUM_DUMMY_TARGETS)
      set(explore_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::explore::wrapped-linker-option${explore_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR explore_NUM_DUMMY_TARGETS "${explore_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::explore::wrapped-linker-option${explore_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND explore_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ams-notebook/ams-bw-ws2425/catkin_ws/devel/.private/explore/lib;/home/ams-notebook/ams-bw-ws2425/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(explore_EXPORTED_TARGETS ${${explore_dep}_EXPORTED_TARGETS})
endforeach()
